package com.example.myproject.CommonMethod;
...
public class CommonMethod {
    public static String  ipConfig = "http://192.168.0.33:8989";
    //public static String ipConfig = "http://121.148.239.200:80";  //외부 접속용 ip
